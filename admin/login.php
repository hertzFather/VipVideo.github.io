...
<body>
	...
	<ul>
		<li><a href="../">返回首页</a></li>
		<li><a href="http://zzhuti.com" target="_blank">开发者</a></li>
...
<tr class="header">
			<td colspan="4" align="center" style=" height:50px; font-size:18px; font-weight:bold;    background-color: #ecf1fc;">找主题影院系统登陆</td>
</tr>
